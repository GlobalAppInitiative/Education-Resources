...
Git is a version control system that allows developers to collaborate on projects.
...
when things stop working. Collaboration is achieved by keeping a "master" version
...
as collaborators so they can push their changes.
...
- `Atlassian git Tutorial`_: Advanced git concepts with examples
